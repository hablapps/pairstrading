...
historial_tab1: update sym: `SP500 from 1_ flip `open`high`low`close`adjClose`vol!("FFFFFF";",") 0: `:data/stocks/SP500_hist.csv;
historial_tab2: update sym: `NASDAQ100 from 1_ flip `open`high`low`close`adjClose`vol!("FFFFFF";",") 0: `:data/stocks/NASDAQ100_hist.csv;
historial_tab3: update sym: `BFX from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:`:data/stocks/BFX.csv;
historial_tab4: update sym: `FCHI from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:`:data/stocks/FCHI.csv;
historial_tab5: update sym: `GDAXI from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/GDAXI.csv;
historial_tab6: update sym: `HSI from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/HSI.csv;
historial_tab7: update sym: `KS11 from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/KS11.csv;
historial_tab8: update sym: `MXX from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/MXX.csv;
historial_tab9: update sym: `N100 from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/N100.csv;
historial_tab10: update sym: `N225 from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/N225.csv;
historial_tab11: update sym: `NYA from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/NYA.csv;
historial_tab12: update sym: `RUT from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/RUT.csv;
historial_tab13: update sym: `STOXX from 1_ flip `date`open`high`low`close`adjClose`vol!("PFFFFFF";",") 0: `:data/stocks/STOXX.csv;
